...
```sh
git clone https://github.com/ParthShxrma/Container-Experiments
cd Docker_Practices
```
...
## 🔗 Repository Link  
🔗 **GitHub:** [ParthShxrma/container-experiments](https://github.com/ParthShxrma/Container-Experiments)  
